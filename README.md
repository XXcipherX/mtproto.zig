...
| **MiddleProxy** | Telemt-Compatible ME | Optional ME transport for DC1..5 (`use_middle_proxy`); retries TCP candidates, cools failed endpoints for 60 seconds, and promotes a successful fallback endpoint |
